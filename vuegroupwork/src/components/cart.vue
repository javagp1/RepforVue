	...
	export default{
		...
		methods:{
			...
			changeCountForCart(cartid,count,index){
				...
				var ob=this;
				var url="http://192.168.1.14:8088/springmvc190806/ajaxctr/changecountforcart";
				$.ajax(url,{
			...
			getCartList(){
				...
				var ob=this;
				var url="http://192.168.1.14:8088/springmvc190806/ajaxctr/getcartlist";
				$.ajax(url,{
				dataType:"json",
				xhrFields: {"withCredentials": true},
				success:function(result){
					...
					for(var i in result){
						ob.cartlist[i].bgimg={
							"background-image": "url('http://192.168.1.14:8088/springmvc190806/tp/"+result[i].gimgurl+"')"
						};
