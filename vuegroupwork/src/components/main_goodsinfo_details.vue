...
//			$(window).unbind("scroll");
		...
		methods:{
			...
			addToCart(){
				...
				var url="http://127.0.0.1:8088/springmvc190806/ajaxctr/addtocart";
				$.ajax(url,{
						method:"get",
						data:{
							gdid:ob.gdid,
			...
			getAllGoodsSize(){
				...
				var url="http://127.0.0.1:8088/springmvc190806/ajaxctr/getallgoodssize";
				$.ajax(url,{
						method:"get",
						dataType:"json",
						xhrFields: {"withCredentials": true},
			...
			getGoodsDetailByGdid(){
				...
				var url="http://127.0.0.1:8088/springmvc190806/ajaxctr/getgoodsdetailbygdid";
				$.ajax(url,{
						method:"get",
						data:{"gdid":ob.gdid},
						dataType:"json",
						...
						success:function(result){
							ob.goodsinfo=result;
							ob.gimg_style={backgroundImage:"url('http://127.0.0.1:8088/springmvc190806/tp/"+result.gimgurl+"')"}
