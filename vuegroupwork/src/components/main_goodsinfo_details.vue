...
//			$(window).unbind("scroll");
		...
		methods:{
			...
			valid_userOnline(){
				...
				var ob=this;
				ob.useronline=false;
				var url="http://192.168.1.14:8088/springmvc190806/ajaxctr/useronline";
				$.ajax(url,{
			...
			addToCart(){
				...
				var url="http://192.168.1.14:8088/springmvc190806/ajaxctr/addtocart";
				$.ajax(url,{
						method:"get",
						data:{
							gdid:ob.gdid,
			...
			getAllGoodsSize(){
				...
				var url="http://192.168.1.14:8088/springmvc190806/ajaxctr/getallgoodssize";
				$.ajax(url,{
						method:"get",
						dataType:"json",
						xhrFields: {"withCredentials": true},
			...
			getGoodsDetailByGdid(){
				...
				var url="http://192.168.1.14:8088/springmvc190806/ajaxctr/getgoodsdetailbygdid";
				$.ajax(url,{
						method:"get",
						data:{"gdid":ob.gdid},
						dataType:"json",
						...
						success:function(result){
							ob.goodsinfo=result;
							ob.gimg_style={backgroundImage:"url('http://192.168.1.14:8088/springmvc190806/tp/"+result.gimgurl+"')"}
