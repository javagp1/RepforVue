  ...
  <div class="center_box">
    ...
    <div class="iptbox">
      <div style="height: 50px;width: 315px;margin: auto;">
        ...
        <img id="keycode" @click="changeCode()" src="http://192.168.1.14:8086/springMVC/vaildCode" style="margin-left: 0px;cursor: pointer;" height="40px"/>
      </div>
    </div>
    <div class="iptbox">
  ...
  export default {
    ...
    methods: {
      ...
      login() {
          ...
          var url = "http://192.168.1.14:8086/springMVC/userctrl/login";
          $.ajax(url, {
            method: "post",
            data: {
              "logname": ob.logname,
      ...
      validCodeIsOK() {
        ...
        var url = "http://192.168.1.14:8086/springMVC/userctrl/validisok";
        $.ajax(url, {
          method: "get",
          async: false,
          data: {
      ...
      changeCode() {
        ...
        $("#keycode")[0].src = "http://192.168.1.14:8086/springMVC/vaildCode";
